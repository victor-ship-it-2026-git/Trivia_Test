            ...
            VStack(spacing: 0) {
                ...
                TabView(selection: $currentPage) {
                    ...
                    VStack(spacing: 24) {
                                       ...
                                       Text("10,000+ Trivia Challenges")
                                           .font(.system(size: 32, weight: .bold))
                                           .foregroundColor(Color(red: 0.1, green: 0.1, blue: 0.2))
                                           .multilineTextAlignment(.center)
                                           .padding(.horizontal, 32)
                                       
                                       Text("Test your knowledge with thousands of questions across multiple categories and difficulty levels. New questions added regularly!")
                                           .font(.system(size: 16))
